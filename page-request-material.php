            ...
            <div class="common-step-main-content">
                ...
                <div id="STEPCONT2" class="second-content cont">
                    <div class="request-form">
                        ...
                        <div class="common-text fc-main-text">テキストが入ります</div>
                        <span class="common-addjust-line"></span>
                        <div class="common-option-tag-box request-form__margin">
                            <div class="tag">任意</div>
                            <div class="title">所在地</div>
                        ...
                        <div class="common-text fc-main-text">その他</div>
                        <span class="common-addjust-line"></span>
                        <div class="common-required-tag-box request-form__margin-min">
                            <div class="tag">必須</div>
                            <div class="title">物件 その他</div>
                        </div>
                        <div class="common-text fc-main-text">交渉中</div>
                        <span class="common-addjust-line"></span>
                        <div class="common-required-tag-box request-form__margin-min">
                            <div class="tag">必須</div>
                            <div class="title">店舗責任者</div>
                        </div>
                        <div class="common-text fc-main-text">雇用する</div>
                        <span class="common-addjust-line"></span>
                        ...
                        <div class="common-text fc-main-text">約２００万円</div>
                        <span class="common-addjust-line"></span>
                        <div class="common-option-tag-box request-form__margin">
                            <div class="tag">任意</div>
                            <div class="title">自己資金</div>
                        </div>
                        <div class="common-text fc-main-text">約１００万円</div>
                        <span class="common-addjust-line"></span>
                        <div class="common-option-tag-box request-form__margin">
                            <div class="tag">任意</div>
                            <div class="title">借入予定額</div>
                        ...
                        <div class="common-text fc-main-text">約３０万円</div>
                        <span class="common-addjust-line"></span>
                        <div class="common-agreement-box">
                            <label>
                    ...
                    <div class="common-center-button-box request-form__margin-big">
                        <button id="Button2" class="common-button-pink button-more-width">
                            会員登録して資料請求する
                        </button>
                    </div>
                </div>
                ...
                <div id="STEPCONT3" class="third-content cont">
                    <div class="common-sub-titlebox request-form__margin">
                        <h3 class="title" target="_blank">資料請求を受け付けました</h3>
                    </div>
                    <div class="request-form__confirm-box request-form__margin-min">
                        <div class="text">
                            入力いただいたメールアドレスにアカウントの有効化メールをお送りいたしました。<br>
                            30分以内にアカウントの有効化メールのURLにアクセスいただき、アカウントを有効化してください。<br>
                            ログイン後<a href="">マイページ</a>からご請求いただいた資料をご確認いただけます。<br>
                            <br>
                            万一、メールが届かない場合は、トラブルの可能性もありますので<br>
                            大変お手数ではございますが<a href="">こちら</a>にてお問い合わせくださいませ。
                        </div>
                    </div>
                    <div class="common-center-button-box request-form__margin-big">
                        <button id="Button2" class="common-button-pink button-mid-width">
                            資料を確認する
                        </button>
                    </div>
                </div>
                ...
                <div id="STEPCONT3" class="third-content cont">
                    ...
                    <div class="request-form__confirm-box request-form__margin-min">
                        <div class="text">
                            入力いただいたメールアドレスにアカウントの有効化メールをお送りいたしました。<br>
                            <a href="">マイページ</a>からご請求いただいた資料をご確認いただけます。<br>
                            <br>
                            万一、メールが届かない場合は、トラブルの可能性もありますので<br>
                            大変お手数ではございますが<a href="">こちら</a>にてお問い合わせくださいませ。
                        </div>
                ...
                <div id="STEPCONT3" class="third-content cont">
                    ...
                    <div class="request-form__confirm-box request-form__margin-min">
                        <div class="text">
                            入力いただいたメールアドレスに資料請求受付の確認メールをお送りいたしました。<br>
                            30分以内にアカウントの有効化メールのURLにアクセスいただき、アカウントを有効化してください。<br>
                            追って、FC本部担当よりご請求いただいた資料を送付いたします。<br>
                            <br>
                            万一、メールが届かない場合は、トラブルの可能性もありますので<br>
                            大変お手数ではございますが<a href="">こちら</a>にてお問い合わせくださいませ。
                        </div>
